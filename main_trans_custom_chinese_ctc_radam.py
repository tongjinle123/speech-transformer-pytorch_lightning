...
from src.model.transformer_custom.lightning_model_chinese_ctc_radam import LightningModel
...
def main(hparams):
    ...
    logger = TestTubeLogger(exp_root, name=log_folder, version=4005)
    checkpoint = ModelCheckpoint(filepath='exp/lightning_logs/version_4005/checkpoints/',
