...
from src.model.transformer_custom.lightning_model_chinese import LightningModel
...
def main(hparams):
    ...
    logger = TestTubeLogger(exp_root, name=log_folder, version=4003)
    checkpoint = ModelCheckpoint(filepath='exp/lightning_logs/version_4003/checkpoints/',
