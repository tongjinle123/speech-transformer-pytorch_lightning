...
from src.model.transformer.lightning_model_mix import LightningModel
...
def main(hparams):
    ...
    logger = TestTubeLogger(exp_root, name=log_folder, version=1011)
    checkpoint = ModelCheckpoint(filepath='exp/lightning_logs/version_1011/checkpoints/',
