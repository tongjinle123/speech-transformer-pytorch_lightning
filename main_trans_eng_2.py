...
from src.model.transformer.lightning_model_eng_2 import LightningModel
...
def main(hparams):
    ...
    logger = TestTubeLogger(exp_root, name=log_folder, version=1022)
    checkpoint = ModelCheckpoint(filepath='exp/lightning_logs/version_1022/checkpoints/',
