...
from src.model.transformer.lightning_model_eng_3 import LightningModel
...
def main(hparams):
    ...
    logger = TestTubeLogger(exp_root, name=log_folder, version=1023)
    checkpoint = ModelCheckpoint(filepath='exp/lightning_logs/version_1023/checkpoints/',
    ...
    trainer = Trainer(
        ...
        resume_from_checkpoint='exp/lightning_logs/version_1023/checkpoints/epoch=103.ckpt'
        # resume_from_checkpoint='exp/lightning_logs/version_1023/_ckpt_epoch_29.ckpt'
    )
    # if hparams.evaluate:
