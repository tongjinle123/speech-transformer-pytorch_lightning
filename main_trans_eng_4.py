...
from src.model.transformer.lightning_model_eng_4 import LightningModel
...
def main(hparams):
    ...
    logger = TestTubeLogger(exp_root, name=log_folder, version=1024)
    checkpoint = ModelCheckpoint(filepath='exp/lightning_logs/version_1024/checkpoints/',
