...
from src.model.transformer_custom.lightning_model import LightningModel
...
def main(hparams):
    ...
    checkpoint = ModelCheckpoint(filepath='exp/lightning_logs/version_4000/checkpoints/',
