...
from src.model.transformer_custom.lightning_model_tune import LightningModel
...
def main(hparams):
    ...
    logger = TestTubeLogger(exp_root, name=log_folder, version=4002)
    checkpoint = ModelCheckpoint(filepath='exp/lightning_logs/version_4002/checkpoints/',
