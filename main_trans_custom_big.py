...
from src.model.transformer_custom.lightning_model_big import LightningModel
...
def main(hparams):
    ...
    logger = TestTubeLogger(exp_root, name=log_folder, version=4001)
    checkpoint = ModelCheckpoint(filepath='exp/lightning_logs/version_4001/checkpoints/',
