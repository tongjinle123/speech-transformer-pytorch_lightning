...
from src.model.transformer_custom.lightning_model_chinese_ctc import LightningModel
...
def main(hparams):
    ...
    logger = TestTubeLogger(exp_root, name=log_folder, version=4004)
    checkpoint = ModelCheckpoint(filepath='exp/lightning_logs/version_4004/checkpoints/',
