...
from src.model.transformer.lightning_model_finetune import LightningModel
...
def main(hparams):
    ...
    logger = TestTubeLogger(exp_root, name=log_folder, version=1014)
    checkpoint = ModelCheckpoint(filepath='exp/lightning_logs/version_1014/checkpoints/',
