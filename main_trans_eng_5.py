...
from src.model.transformer.lightning_model_eng_5 import LightningModel
...
def main(hparams):
    ...
    logger = TestTubeLogger(exp_root, name=log_folder, version=1025)
    checkpoint = ModelCheckpoint(filepath='exp/lightning_logs/version_1025/checkpoints/',
    ...
    trainer = Trainer(
        ...
        # resume_from_checkpoint='exp/lightning_logs/version_1024/checkpoints/epoch=49.ckpt'
