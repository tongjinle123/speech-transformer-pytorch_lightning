...
class LightningModel(pl.LightningModule):
    ...
    def training_step(self, batch, batch_nb):
        ...
        # loss = ce_loss * 0.5 + 0.3 * ctc_loss + switch_loss * 0.1 + ctc_switch_loss * 0.1
        loss = ce_loss * 0.8 + switch_loss * 0.2
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument('--feature_dim', default=560, type=int)
        ...
        parser.add_argument('--warm_up_step', default=8000, type=int)
