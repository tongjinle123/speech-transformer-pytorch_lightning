...
class LightningModel(pl.LightningModule):
    ...
    def training_step(self, batch, batch_nb):
        ...
        loss = ce_loss * 0.7 + switch_loss * 0.1 + ctc_loss * 0.1 + ctc_switch_loss * 0.1
    ...
    def validation_end(self, outputs):
        ...
        ctc_switch_loss = t.stack([i['enc_switch'] for i in outputs]).mean()
        ...
        # print('mer', mer)
        return {'val_loss': val_loss, 'val_ce_loss': ce_loss, 'log': {'val_loss': val_loss, 'val_ce_loss': ce_loss,'ctc_loss': ctc_loss,'enc_switch':ctc_switch_loss}}
