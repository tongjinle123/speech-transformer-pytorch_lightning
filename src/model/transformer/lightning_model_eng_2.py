...
from src.model.transformer.transformer2 import Transformer
from src.utils.ranger import Ranger
from src.utils.score import cal_wer
from src.utils.tokenizer import tokenize
import numpy as np
from src.utils.adamod import AdaMod
...
class LightningModel(pl.LightningModule):
    ...
    def __build_model(self):
        ...
        # x = t.load('exp/lightning_logs/version_1023/checkpoints/_ckpt_epoch_29.ckpt')['state_dict']
    ...
    def validation_end(self, outputs):
        ...
        print('mer', mer)
        ret = {
            'val_loss': val_loss, 'val_ce_loss': ce_loss, 'val_ctc_loss': ctc_loss, 'val_mer': mer,
            'log': {
    ...
    def configure_optimizers(self):
        # optimizer = Ranger(self.parameters(), lr=self.hparams.lr)
        optimizer = t.optim.SGD(self.parameters(), lr=5e-5)
        # optimizer = t.optim.Adam(self.parameters(), lr=5e-5, eps=1e-4)
        # optimizer = AdaMod(self.parameters(), lr=self.hparams.lr, betas=(0.9, 0.999), eps=1e-4)
