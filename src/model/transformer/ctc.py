...
class Transformer(t.nn.Module):
    def __init__(self, num_time_mask=2, num_freq_mask=2, freq_mask_length=15, time_mask_length=15, feature_dim=320,
                 ...
                 enable_spec_augment=True, share_weight=True, encoder_left_length=20, encoder_right_length=20):
        ...
        self.encoder_left_length = encoder_left_length
        self.encoder_right_length = encoder_right_length
    ...
    def forward(self, feature, feature_length, ori_token, ori_token_length):
        ...
        #
        spec_feature = self.spec_encoder(feature, feature_mask, None)
        #
